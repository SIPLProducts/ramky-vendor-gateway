...
serve(async (req) => {
  ...
  try {
    ...
    const subject = "Reset your Ramky Vendor Portal password";
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; padding: 24px; color: #1F2937;">
        <h2 style="color: #195B9B; margin: 0 0 12px;">Reset your password</h2>
        <p>Hi,</p>
        <p>We received a request to reset the password for your Ramky Vendor Portal account.</p>
        ...
        <p style="font-size: 11px; color: #9CA3AF;">Ramky Vendor Portal · Do not reply to this email.</p>
      </div>
    `;
