        ...
        if (!buyerEmail) {
          ...
          const html = `
            <div style="font-family:Arial,sans-serif;color:#111;max-width:640px;margin:auto">
              ...
              <p>Please log in to the Vendor Portal to review the remarks, update the vendor information, and resubmit. Once resubmitted, the application will restart the approval workflow (SCM CO → SCM Head → Finance 1 → Finance 2 → ...).</p>
