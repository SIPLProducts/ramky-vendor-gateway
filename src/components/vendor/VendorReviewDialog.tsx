      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {loading ? (
          ...
          <Tabs defaultValue="details" className="w-full flex-1 min-h-0 overflow-hidden flex flex-col">
            ...
            <TabsContent value="documents" className="mt-4 flex-1 min-h-0 overflow-auto">
              <VendorDocuments vendorId={vendor.id} hideDownload />
            </TabsContent>


            <TabsContent value="gst_compliance" className="mt-4 flex-1 min-h-0 flex flex-col gap-3">
